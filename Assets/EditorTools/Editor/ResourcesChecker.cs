...
public class ResourcesChecker : EditorWindow
{
    ...
    [MenuItem("EditorTools/Resource Checker")]
    static void Init()
    {
        ResourcesChecker window = (ResourcesChecker)EditorWindow.GetWindow(typeof(ResourcesChecker));
