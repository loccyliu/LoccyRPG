...
public static class Tools
{
    ...
    static public Rect IntRect(string prefix, Rect rect)
    {
        ...
        Tools.IntVector a = Tools.IntPair(prefix, "Left", "Top", left, top);
        Tools.IntVector b = Tools.IntPair(null, "Width", "Height", width, height);
    ...
    static public Vector4 IntPadding(string prefix, Vector4 v)
    {
        ...
        Tools.IntVector a = Tools.IntPair(prefix, "Left", "Top", left, top);
        Tools.IntVector b = Tools.IntPair(null, "Right", "Bottom", right, bottom);
    ...
    public static void DrawTexture(Texture2D tex, Rect rect, Rect uv, Color color, Material mat)
    {
        ...
        // Draw the background
        Tools.DrawTiledTexture(outerRect, Tools.backdropTexture);
    ...
    static public void DrawBorderProperty(string name, SerializedObject serializedObject, string field)
    {
        if (serializedObject.FindProperty(field) != null)
        {
            GUILayout.BeginHorizontal();
            {
                ...
                Tools.SetLabelWidth(50f);
                GUILayout.BeginVertical();
                Tools.DrawProperty("Left", serializedObject, field + ".x", GUILayout.MinWidth(80f));
                Tools.DrawProperty("Bottom", serializedObject, field + ".y", GUILayout.MinWidth(80f));
                GUILayout.EndVertical();

                GUILayout.BeginVertical();
                Tools.DrawProperty("Right", serializedObject, field + ".z", GUILayout.MinWidth(80f));
                Tools.DrawProperty("Top", serializedObject, field + ".w", GUILayout.MinWidth(80f));
                GUILayout.EndVertical();
    ...
    static public void DrawRectProperty(string name, SerializedObject serializedObject, string field, float labelWidth, float spacing)
    {
        if (serializedObject.FindProperty(field) != null)
        {
            GUILayout.BeginHorizontal();
            {
                ...
                Tools.SetLabelWidth(20f);
                GUILayout.BeginVertical();
                Tools.DrawProperty("X", serializedObject, field + ".x", GUILayout.MinWidth(50f));
                Tools.DrawProperty("Y", serializedObject, field + ".y", GUILayout.MinWidth(50f));
                GUILayout.EndVertical();

                Tools.SetLabelWidth(50f);
                GUILayout.BeginVertical();
                Tools.DrawProperty("Width", serializedObject, field + ".width", GUILayout.MinWidth(80f));
                Tools.DrawProperty("Height", serializedObject, field + ".height", GUILayout.MinWidth(80f));
                GUILayout.EndVertical();
    ...
    static public void DrawEvents(string text, Object undoObject, List<EventDelegate> list,  string notValid)
    {
        if (!Tools.DrawHeader(text, text, false, false)) return;

        Tools.BeginContents(false);
        GUILayout.BeginHorizontal();
        GUILayout.BeginVertical();

        EventDelegateEditor.Field(undoObject, list, notValid, notValid, false);
