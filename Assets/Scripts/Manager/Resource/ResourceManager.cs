...
public class ResourceManager : MonoBehaviour
{
	...
	/// 载入素材
	/// </summary>
	public void LoadAsset (string abname, string assetname, Action<GameObject> func)
	{
		abname = abname.ToLower ();
		StartCoroutine (OnLoadAsset (abname, assetname, func));
	}

	IEnumerator OnLoadAsset (string abname, string assetName, Action<GameObject> func)
	{
